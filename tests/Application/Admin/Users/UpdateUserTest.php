...
class UpdateUserTest extends ChiefTestCase
{
    ...
    public function test_full_admin_can_see_the_edit_view()
    {
    ...
    public function test_only_authenticated_admin_can_update_a_user()
    {
    ...
    public function test_regular_author_cannot_update_any_user()
    {
    ...
    public function test_a_non_developer_cannot_update_an_existing_developer()
    {
    ...
    public function test_non_developer_cannot_give_developer_role_to_user()
    {
        $response = $this->asAdmin()->put(route('chief.back.users.update', $this->newUser->id), $this->validUpdateParams([
            'roles' => ['developer'],
        ]));
