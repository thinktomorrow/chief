...
//    /** @test */
    ...
    {
        $this->assertValidation(new User(), 'firstname', $this->validUpdateParams(['firstname' => '']), route('chief.back.users.index'), route('chief.back.users.update', $this->newUser->id), 2, // Admin self and existing one
            'put');
    }
    ...
    {
        $this->assertValidation(new User(), 'lastname', $this->validUpdateParams(['lastname' => '']), route('chief.back.users.index'), route('chief.back.users.update', $this->newUser->id), 2, // Admin self and existing one
            'put');
    }
