...
class AssetTraitTest extends TestCase
{
    ...
    public function it_can_get_a_file_url_with_a_type()
    {
        ...
        $article = Asset::upload(UploadedFile::fake()->image('bannerImage.png'), 'banner')->attachToModel($article);
    ...
    public function it_can_get_a_file_url_with_a_type_and_size()
    {
        ...
        Asset::upload(UploadedFile::fake()->image('image.png'), 'banner')->attachToModel($article);
    ...
    public function it_can_get_a_file_url_with_type_for_locale()
    {
        ...
        Asset::upload(UploadedFile::fake()->image('image.png'), 'banner', 'nl')->attachToModel($article);
    ...
    public function it_can_add_a_file_translation_for_default_locale()
    {
        ...
        $article->addFile(UploadedFile::fake()->image('image.png'),'banner','fr');
