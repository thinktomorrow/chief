...
var Submissions = {
  isSubmitting: function isSubmitting(url) {
    return submissionsInProgress.includes(url);
  },
  addSubmission: function addSubmission(url) {
    submissionsInProgress.push(url);
  },
  removeSubmission: function removeSubmission(url) {
    var index = submissionsInProgress.indexOf(url);
    if (index !== -1) {
  ...
  listenForFormSubmits: function listenForFormSubmits(container, successCallback, errorCallback) {
    ...
    forms.forEach(function (form) {
      form.addEventListener('submit', function (event) {
        ...
        var spinner = form.querySelector('[data-form-submit-spinner]');
        if (spinner) {
...
var Form = function Form(el, sidebar) {
  ...
  this.sidebarClick = function (event) {
    return _this.handleSidebarClick(event);
  };
};
...
Form.prototype.refresh = function () {
  ...
  _Api__WEBPACK_IMPORTED_MODULE_9__["default"].get(url, function (data) {
    ...
    (0,_fields_vue_fields__WEBPACK_IMPORTED_MODULE_10__["default"])(_this3.el);
...
/* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Form */ "./resources/assets/js/forms/Form.js");
...
var Forms = function Forms(mainContainer, sidebar) {
  var _this = this;
  this.sidebar = sidebar;
  this.mainContainer = mainContainer;
  this.selector = '[data-form]';
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('chief-form-submitted', function (e) {
    var inSidebar = _this.sidebar.sidebarContainer.el.contains(e.currentElement);
    var targetElement = inSidebar && _this.sidebar.findPanelTarget() ? _this.sidebar.findPanelTarget().el : _this.mainContainer;
    ...
    if (inSidebar) {
      _this.handleSubmitFromSidebar(e.response, e.meta);
    }
    _this.refreshIn(e.tags, targetElement);
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('sidebarPanelActivated', function (e) {
    _this.load(e.panel.el);
...
Forms.prototype.load = function () {
  ...
  container.querySelectorAll(this.selector).forEach(function (el) {
    new _Form__WEBPACK_IMPORTED_MODULE_5__["default"](el, _this2.sidebar).refreshCallback();
  });
};
Forms.prototype.listenIn = function () {
  ...
  var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  container.querySelectorAll(this.selector).forEach(function (el) {
    new _Form__WEBPACK_IMPORTED_MODULE_5__["default"](el, _this3.sidebar).listen();
  });
};
Forms.prototype.refreshIn = function (tags) {
  var _this4 = this;
  var container = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
  Array.from(container.querySelectorAll(this.selector)).forEach(function (el) {
    var form = new _Form__WEBPACK_IMPORTED_MODULE_5__["default"](el, _this4.sidebar);
    if (form.hasTag(tags)) {
      form.refresh();
    }
  });
...
/* harmony import */ var _utilities_EventBus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utilities/EventBus */ "./resources/assets/js/utilities/EventBus.js");




var Submit = {
  handle: function handle(responseData, currentElement, tags, meta, successCallback, alwaysCallback) {
    // Reset any error
...
/***/ "./resources/assets/js/forms/conditional-fields/CheckboxFieldTrigger.js":
/*!******************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/CheckboxFieldTrigger.js ***!
  \******************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ConditionalFieldTrigger */ "./resources/assets/js/forms/conditional-fields/ConditionalFieldTrigger.js");
...
}(_ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_15__["default"]);


/***/ }),

/***/ "./resources/assets/js/forms/conditional-fields/ConditionalFieldTrigger.js":
/*!*********************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/ConditionalFieldTrigger.js ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var ConditionalFieldTrigger = /*#__PURE__*/function () {
  ...
  _createClass(ConditionalFieldTrigger, [{
    ...
    value: function _watch() {
      var _this = this;
      this.element.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_26___default()(function () {
        _this._handle();
      }, 250));
    }
    ...
    value: function _hideConditionalField(element) {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_25___default()(triggers)) {
    ...
    value: function _createConditionalFieldsObject(data) {
      ...
      for (var _i = 0, _Object$entries = Object.entries(data); _i < _Object$entries.length; _i++) {
        ...
        if (!element) {
          console.error( /* eslint-disable-next-line */"Error while trying to create conditional fields: Couldn't find formgroup with key ".concat(key, ". Make sure this field exists on this model."));
        } else {
          output.push({
            element: element,
            values: value
...
/***/ "./resources/assets/js/forms/conditional-fields/InputFieldTrigger.js":
/*!***************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/InputFieldTrigger.js ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ConditionalFieldTrigger */ "./resources/assets/js/forms/conditional-fields/ConditionalFieldTrigger.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
/***/ "./resources/assets/js/forms/conditional-fields/MultiSelectFieldTrigger.js":
/*!*********************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/MultiSelectFieldTrigger.js ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ MultiSelectFieldTrigger; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.map.js */ "./node_modules/core-js/modules/es.array.map.js");
/* harmony import */ var core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_0__);
...
var MultiSelectFieldTrigger = /*#__PURE__*/function (_ConditionalFieldTrig) {
  _inherits(MultiSelectFieldTrigger, _ConditionalFieldTrig);
  var _super = _createSuper(MultiSelectFieldTrigger);
  function MultiSelectFieldTrigger() {
    _classCallCheck(this, MultiSelectFieldTrigger);
    return _super.apply(this, arguments);
  }
  _createClass(MultiSelectFieldTrigger, [{
    key: "_handle",
    value: function _handle() {
    ...
    value: function _watch() {
      var _this = this;
      window.Eventbus.$on('updated-select', lodash_debounce__WEBPACK_IMPORTED_MODULE_14___default()(function () {
        _this._handle();
      }, 250));
    }
  }, {
  ...
  return MultiSelectFieldTrigger;
}(_ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_15__["default"]);


/***/ }),

/***/ "./resources/assets/js/forms/conditional-fields/RadioFieldTrigger.js":
/*!***************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/RadioFieldTrigger.js ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/assets/js/forms/conditional-fields/SelectFieldTrigger.js":
/*!****************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/SelectFieldTrigger.js ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var SelectFieldTrigger = /*#__PURE__*/function (_ConditionalFieldTrig) {
  ...
  _createClass(SelectFieldTrigger, [{
    ...
    value: function _getCurrentValuesFromSelectElement() {
      var selectElement = this.element.querySelector('select');
      return Array.from(selectElement.querySelectorAll('option')).filter(function (option) {
...
/***/ "./resources/assets/js/forms/conditional-fields/init-conditional-fields.js":
/*!*********************************************************************************!*\
  !*** ./resources/assets/js/forms/conditional-fields/init-conditional-fields.js ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _InputFieldTrigger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./InputFieldTrigger */ "./resources/assets/js/forms/conditional-fields/InputFieldTrigger.js");
/* harmony import */ var _RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./RadioFieldTrigger */ "./resources/assets/js/forms/conditional-fields/RadioFieldTrigger.js");
/* harmony import */ var _CheckboxFieldTrigger__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CheckboxFieldTrigger */ "./resources/assets/js/forms/conditional-fields/CheckboxFieldTrigger.js");
/* harmony import */ var _SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./SelectFieldTrigger */ "./resources/assets/js/forms/conditional-fields/SelectFieldTrigger.js");
/* harmony import */ var _MultiSelectFieldTrigger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./MultiSelectFieldTrigger */ "./resources/assets/js/forms/conditional-fields/MultiSelectFieldTrigger.js");
 ...
 */
var initConditionalFieldsInContainer = function initConditionalFieldsInContainer() {
  var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  var formgroupAttribute = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'data-field-key';
  var formgroupTypeAttribute = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'data-field-type';
  var conditionalFieldsDataAttribute = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'data-conditional-toggle';
  var formgroupElements = Array.from(container.querySelectorAll("[".concat(formgroupAttribute, "]")));
  formgroupElements.forEach(function (element) {
    ...
    var conditionalFieldsData = JSON.parse(element.getAttribute(conditionalFieldsDataAttribute));
    ...
    switch (type) {
      case 'input':
        new _InputFieldTrigger__WEBPACK_IMPORTED_MODULE_6__["default"](name, element, conditionalFieldsData);
        break;
      case 'radio':
        new _RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_7__["default"](name, element, conditionalFieldsData);
        break;
      case 'checkbox':
        new _CheckboxFieldTrigger__WEBPACK_IMPORTED_MODULE_8__["default"](name, element, conditionalFieldsData);
        break;
      case 'select':
        new _SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_9__["default"](name, element, conditionalFieldsData);
        break;
      case 'multiselect':
        new _MultiSelectFieldTrigger__WEBPACK_IMPORTED_MODULE_10__["default"](name, element, conditionalFieldsData);
        break;
      default:
        console.error( /* eslint-disable-next-line */"Error while trying to initialise conditional fields: Trigger handling for type ".concat(type, " is not implemented yet ..."));
    }
  });
};
var initConditionalFields = function initConditionalFields() {
  initConditionalFieldsInContainer(document);
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].subscribe('sidebarPanelActivated', function (e) {
...
/* harmony import */ var _repeat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./repeat */ "./resources/assets/js/forms/fields/repeat.js");


function initRepeatFields() {
  (0,_repeat__WEBPACK_IMPORTED_MODULE_1__.initRepeatFieldsIn)(document);
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('sidebarPanelActivated', function (data) {
    (0,_repeat__WEBPACK_IMPORTED_MODULE_1__.initRepeatFieldsIn)(data.panel.el);
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('chief-form-refreshed', function (e) {
    (0,_repeat__WEBPACK_IMPORTED_MODULE_1__.initRepeatFieldsIn)(e.element);
  });
}
...
/* harmony export */   initRepeatFieldsIn: function() { return /* binding */ initRepeatFieldsIn; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
/* harmony import */ var _vue_fields__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./vue-fields */ "./resources/assets/js/forms/fields/vue-fields.js");
...
function initRepeatFieldsIn(container) {
  ...
  Array.from(container.querySelectorAll(repeatContainerSelector)).forEach(function (repeatElement) {
    new Repeat(repeatElement.dataset.repeatEndpoint, repeatElement.id, '[data-repeat-section]', repeatElement.dataset.repeatSectionName, repeatContainerSelector);
  });
}
var Repeat = function Repeat(endpoint, containerId, sectionSelector, prefix, containerSelector) {
  var _this = this;
  ...
  if (!this.container) {
    console.error("container by id ".concat(this.containerId, " not found."));
    return;
  }
  this.init();
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_14__["default"].subscribe('chief-repeat-index-changed', function (data) {
    if (data.section.contains(_this.container) && _this.prefix.startsWith(data.former_prefix)) {
      _this.prefix = _this.prefix.replace(data.former_prefix, data.new_prefix);
    }
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_14__["default"].subscribe('chief-form-refreshed', function (e) {
    ...
    if (!e.element.contains(_this.container)) {
      return;
    }
    _this.init();
  });
...
Repeat.prototype.eventListeners = function () {
  var _this2 = this;
  Array.from(this.container.querySelectorAll('[data-add-repeat-section]')).filter(function (el) {
    return el.closest(_this2.containerSelector) === _this2.container;
  }).forEach(function (el) {
    el.removeEventListener('click', _this2.handleAddSection);
    el.addEventListener('click', _this2.handleAddSection);
  });
  Array.from(this.container.querySelectorAll('[data-delete-repeat-section]')).filter(function (el) {
    return el.closest(_this2.containerSelector) === _this2.container;
  }).forEach(function (el) {
    el.removeEventListener('click', _this2.handleDeleteSection);
    el.addEventListener('click', _this2.handleDeleteSection);
  });
};
Repeat.prototype.addSection = function () {
  var _this3 = this;
  var nextIndex = this.getSections().length;
  var url = "".concat(this.endpoint, "?index=").concat(nextIndex, "&prefix=").concat(this.prefix);
  fetch(url).then(function (response) {
    if (!response.ok) throw response;
    return response.json();
  }).then(function (json) {
    _this3.insertSection(json.data);
...
Repeat.prototype.insertSection = function (sectionHtml) {
  ...
  (0,_vue_fields__WEBPACK_IMPORTED_MODULE_15__["default"])(sectionElement);
...
Repeat.prototype.getSections = function () {
  return this.container.querySelectorAll(":scope > ".concat(this.sectionSelector));
};
...
Repeat.prototype.order = function () {
  ...
  this.getSections().forEach(function (section) {
    ...
    Array.from(section.querySelectorAll("[name^=\"".concat(_this4.prefix, "[\"]")))
    // .filter((_el) => _el.closest(this.containerSelector) === this.container)
    .forEach(function (node) {
      var match = node.getAttribute('name').match(new RegExp("".concat(_this4.escapeForRegExp(_this4.prefix), "\\[([0-9]+)\\]"), 'g'));
      if (!match) {
        console.error(_this4.prefix);
      }
      if (!match) return;
      var formerPrefix = match[0];
      var indexedName = node.getAttribute('name').replace(formerPrefix, "".concat(_this4.prefix, "[").concat(index, "]"));
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_14__["default"].publish('chief-repeat-index-changed', {
        section: section,
        former_prefix: formerPrefix,
        new_prefix: "".concat(_this4.prefix, "[").concat(index, "]")
      });
...
Repeat.prototype.initSortable = function () {
  ...
  var existingSortable = sortablejs__WEBPACK_IMPORTED_MODULE_13__["default"].get(this.container);
  if (existingSortable) {
    existingSortable.destroy();
  }
  sortablejs__WEBPACK_IMPORTED_MODULE_13__["default"].create(this.container, {
...
/* harmony import */ var _utilities_form_submit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/form-submit */ "./resources/assets/js/forms/utilities/form-submit.js");
/* harmony import */ var _fields_init_repeat_fields__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fields/init-repeat-fields */ "./resources/assets/js/forms/fields/init-repeat-fields.js");
/* harmony import */ var _conditional_fields_init_conditional_fields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./conditional-fields/init-conditional-fields */ "./resources/assets/js/forms/conditional-fields/init-conditional-fields.js");
/* harmony import */ var _utilities_form_notifications__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utilities/form-notifications */ "./resources/assets/js/forms/utilities/form-notifications.js");
/* harmony import */ var _utilities_character_count__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utilities/character-count */ "./resources/assets/js/forms/utilities/character-count.js");
...
document.addEventListener('DOMContentLoaded', function () {
  new _Forms__WEBPACK_IMPORTED_MODULE_1__["default"](document.getElementById('content'), new _sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_0__["default"]()).load(document);
  (0,_fields_init_repeat_fields__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_conditional_fields_init_conditional_fields__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_utilities_form_notifications__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_utilities_character_count__WEBPACK_IMPORTED_MODULE_6__["default"])();
  _utilities_form_submit__WEBPACK_IMPORTED_MODULE_2__["default"].listen('[data-submit-form]');
});
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../Api */ "./resources/assets/js/forms/Api.js");
/* harmony import */ var _Panel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Panel */ "./resources/assets/js/forms/sidebar/Panel.js");
/* harmony import */ var _Panels__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Panels */ "./resources/assets/js/forms/sidebar/Panels.js");
...
/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Container */ "./resources/assets/js/forms/sidebar/Container.js");
/* harmony import */ var _fields_vue_fields__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../fields/vue-fields */ "./resources/assets/js/forms/fields/vue-fields.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var _default = /*#__PURE__*/function () {
  function _default() {
    ...
    this.panels = new _Panels__WEBPACK_IMPORTED_MODULE_14__["default"]();
    this.sidebarContainer = new _Container__WEBPACK_IMPORTED_MODULE_16__["default"](document.getElementById('js-sidebar-container'));
  ...
  _createClass(_default, [{
    ...
    value: function show(url) {
      ...
      var id = _Panels__WEBPACK_IMPORTED_MODULE_14__["default"].createId(url);
    ...
    value: function fetchUrl(url) {
      var _this3 = this;
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var panelId = _Panels__WEBPACK_IMPORTED_MODULE_14__["default"].createId(url);
      ...
      _Api__WEBPACK_IMPORTED_MODULE_12__["default"].get(url, function (data) {
        ...
        (0,_fields_vue_fields__WEBPACK_IMPORTED_MODULE_17__["default"])(panelEl);
        ...
        _this3.panels.add(new _Panel__WEBPACK_IMPORTED_MODULE_13__["default"](panelId, url, _this3.panels.findActive() ? _this3.panels.findActive() : null, panelEl, options));
        ...
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_15__["default"].publish('sidebarPanelCreated', {
          panel: _this3.panels.findActive()
        });
      });
    }
    ...
    key: "findPanelTarget",
    value: function findPanelTarget() {
      return this.panels.findFirstSubmitTarget(this.panels.findActive().parent);
    }
  }, {
    key: "backAfterSubmit",
    value: function backAfterSubmit() {
      var targetPanel = this.panels.findFirstSubmitTarget(this.panels.findActive().parent);
      if (!targetPanel) {
        this.close();
        return;
      }
    ...
    value: function refresh() {
      ...
      this.replacePanelComponents(function () {
        ...
        if (_this5.panels.findActive()) {
          _utilities_EventBus__WEBPACK_IMPORTED_MODULE_15__["default"].publish('sidebarPanelActivated', {
    ...
    value: function replacePanelComponents(callback, data) {
      ...
      if (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_12__["default"].get(this.panels.findActive().url, function (_data) {
...
/***/ "./resources/assets/js/forms/utilities/character-count.js":
/*!****************************************************************!*\
  !*** ./resources/assets/js/forms/utilities/character-count.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initCharacterCount; }
/* harmony export */ });
...
var characterCount = function characterCount(container, characterCountEl) {
...
var initCharacterCount = function initCharacterCount() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-character-count]';
  // Scan triggers on initial pageload
  Array.from(document.querySelectorAll(selector)).forEach(function (el) {
    characterCount(document, el);
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].subscribe('chief-form-refreshed', function (data) {
    Array.from(data.element.querySelectorAll(selector)).forEach(function (el) {
      characterCount(data.element, el);
    });
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].subscribe('sidebarPanelActivated', function (data) {
    Array.from(data.panel.el.querySelectorAll(selector)).forEach(function (el) {
...
/***/ "./resources/assets/js/forms/utilities/form-notifications.js":
/*!*******************************************************************!*\
  !*** ./resources/assets/js/forms/utilities/form-notifications.js ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initFormNotifications; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
var initUnsavedNotification = function initUnsavedNotification(container, notificationSelector) {
  var notification = container.querySelector(notificationSelector);
  if (notification) {
...
var initUnsavedNotifications = function initUnsavedNotifications(formSelector) {
  var notificationSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-form-unsaved-notification]';
  Array.from(document.querySelectorAll(formSelector)).forEach(function (form) {
    initUnsavedNotification(form, notificationSelector);
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('chief-form-refreshed', function (data) {
    initUnsavedNotification(data.element, notificationSelector);
  });
};
var initRefreshedNotifications = function initRefreshedNotifications() {
  var notificationSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-form-refreshed-notification]';
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('chief-form-refreshed', function (data) {
    var notification = data.element.querySelector(notificationSelector);
    if (notification) {
      notification.classList.remove('hidden');
    }
  });
};
var initFormNotifications = function initFormNotifications() {
  var formSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-form]';
...
/***/ "./resources/assets/js/forms/utilities/form-submit.js":
/*!************************************************************!*\
  !*** ./resources/assets/js/forms/utilities/form-submit.js ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/assets/js/sortable/sortable-init.js":
/*!*******************************************************!*\
  !*** ./resources/assets/js/sortable/sortable-init.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _sortable__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./sortable */ "./resources/assets/js/sortable/sortable.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
 ...
 * @param options
 */
var initSortable = function initSortable(selector) {
  var container = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  Array.from(container.querySelectorAll(selector)).forEach(function (el) {
    new _sortable__WEBPACK_IMPORTED_MODULE_16__["default"](el, _objectSpread(_objectSpread({}, {
...
/***/ "./resources/assets/js/sortable/sortable-livewire.js":
/*!***********************************************************!*\
  !*** ./resources/assets/js/sortable/sortable-livewire.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
 ...
 */
window.Livewire.directive('sortable', function (el) {
  el.sortable = sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(el, {
...
/***/ "./resources/assets/js/sortable/sortable-toggle.js":
/*!*********************************************************!*\
  !*** ./resources/assets/js/sortable/sortable-toggle.js ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
SortableToggle.prototype.showSorting = function () {
  ...
  this.classWhenSortingEls.forEach(function (el) {
    el.classList.add(el.getAttribute('data-sortable-class-when-sorting').split(','));
  });
  this.classWhenNotSortingEls.forEach(function (el) {
...
/***/ "./resources/assets/js/sortable/sortable.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/sortable/sortable.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ SortableGroup; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
/* harmony import */ var _utilities_EventBus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities/EventBus */ "./resources/assets/js/utilities/EventBus.js");
/* harmony import */ var _sortable_toggle__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sortable-toggle */ "./resources/assets/js/sortable/sortable-toggle.js");
...
var SortableGroup = function SortableGroup(el, options) {
  this.Sortables = [];
...
SortableGroup.prototype._init = function () {
  ...
  this.Sortables.push(sortablejs__WEBPACK_IMPORTED_MODULE_6__["default"].create(this.sortableGroupEl, {
    ...
    onEnd: function onEnd(evt) {
      ...
      var itemId = evt.item.dataset.sortableId;
      var parentId = evt.to.dataset.sortableGroupId || null;
      fetch(self.nestedEndpoint, {
        ...
        window.Eventbus.$emit('create-notification', 'error', 'Het item kan niet worden verplaatst. Er is iets misgelopen.️');
        console.error(error);
      });
    },
    // Sort new order
    store: {
      set: function set(sortable) {
        ...
        fetch(self.endpoint, {
          ...
          _utilities_EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].publish('sortableStored');
        }).catch(function (error) {
...
/***/ "./resources/assets/js/tables/bulk-actions.js":
/*!****************************************************!*\
  !*** ./resources/assets/js/tables/bulk-actions.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initBulkActions; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.from.js */ "./node_modules/core-js/modules/es.array.from.js");
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_string_iterator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.string.iterator.js */ "./node_modules/core-js/modules/es.string.iterator.js");
 ...
 */
var BulkActions = /*#__PURE__*/function () {
  function BulkActions() {
    ...
    this.bulkActionsCounter = this.bulkActionsContainer.querySelector("[".concat(this.bulkActionsCounterAttribute, "]"));
    ...
    if (!this.parentCheckbox || lodash_isEmpty__WEBPACK_IMPORTED_MODULE_14___default()(this.itemCheckboxes)) return;
    this._init();
  }
  _createClass(BulkActions, [{
    ...
    value: function _init() {
      ...
      this.parentCheckbox.addEventListener('change', function () {
        _this._updateItemCheckboxes();
        var count = _this._getBulkActionsCount();
        _this._updateBulkActionsCounter(count);
        _this._syncBulkItemsFields();
      });
      this.itemCheckboxes.forEach(function (checkbox) {
        checkbox.addEventListener('change', function () {
          _this._updateParentCheckbox();
          _this.constructor._updateItemRowStyle(checkbox);
          var count = _this._getBulkActionsCount();
          _this._updateBulkActionsCounter(count);
          _this._syncBulkItemsFields();
        });
    ...
    key: "_updateItemCheckboxes",
    value: function _updateItemCheckboxes() {
      var _this2 = this;
      this.itemCheckboxes.forEach(function (checkbox) {
        checkbox.checked = _this2.parentCheckbox.checked;
        _this2.constructor._updateItemRowStyle(checkbox);
      });
    }
  }, {
    key: "_updateParentCheckbox",
    value: function _updateParentCheckbox() {
      // If all checkboxes are checked, set parent checkbox to checked
      if (this.itemCheckboxes.every(function (checkbox) {
      ...
      if (!this.itemCheckboxes.some(function (checkbox) {
        return checkbox.checked;
      })) {
        this.parentCheckbox.indeterminate = false;
    ...
    key: "_getBulkActionsCount",
    value: function _getBulkActionsCount() {
      var count = 0;
      for (var i = 0; i < this.itemCheckboxes.length; i++) {
        if (this.itemCheckboxes[i].checked) count++;
      }
      return count;
    }
  }, {
    key: "_updateBulkActionsCounter",
    value: function _updateBulkActionsCounter(count) {
    ...
    key: "_toggleBulkActionsContainer",
    value: function _toggleBulkActionsContainer(count) {
      if (count > 0) {
    ...
    key: "_syncBulkItemsFields",
    value: function _syncBulkItemsFields() {
      // Current selection
      ...
      this.bulkActionItemFields.forEach(function (el) {
    ...
    value: function _getSelectedValues() {
      return this.itemCheckboxes.filter(function (el) {
        return el.checked;
      }).map(function (el) {
        return el.value;
      });
    ...
    key: "_updateItemRowStyle",
    value: function _updateItemRowStyle(checkbox) {
      ...
      var row = checkbox.closest('[data-table-row]');
      var highlightClass = 'bg-primary-50';
      if (checkbox.checked) {
...
var initBulkActions = function initBulkActions() {
  var containerSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-table-container]';
...
/***/ "./resources/assets/js/tables/index.js":
/*!*********************************************!*\
  !*** ./resources/assets/js/tables/index.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bulk_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bulk-actions */ "./resources/assets/js/tables/bulk-actions.js");

document.addEventListener('DOMContentLoaded', function () {
  (0,_bulk_actions__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
...
/***/ "./resources/assets/js/utilities/animated-toggle.js":
/*!**********************************************************!*\
  !*** ./resources/assets/js/utilities/animated-toggle.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initAnimatedToggle; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
 ...
 */
var AnimatedToggle = /*#__PURE__*/function () {
  function AnimatedToggle(container, toggles) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  _createClass(AnimatedToggle, [{
    ...
    value: function _close() {
      ...
      this.animationClasses.forEach(function (animationClass) {
        _this2.container.classList.remove(animationClass);
      });
      ...
      this.animationClasses.forEach(function (animationClass) {
        _this2.container.classList.add(animationClass);
      });
      var onAnimationEnd = function onAnimationEnd() {
        _this2.container.classList.add('hidden');
        _this2.container.style.animationDirection = 'normal';
        _this2.container.removeEventListener('animationend', onAnimationEnd);
        _this2.onClose();
      };
...
var initAnimatedToggle = function initAnimatedToggle() {
  var containerSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-mobile-navigation]';
  var toggleSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-toggle-mobile-navigation]';
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
/***/ "./resources/assets/js/utilities/collapsible-navigation.js":
/*!*****************************************************************!*\
  !*** ./resources/assets/js/utilities/collapsible-navigation.js ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initCollapsibleNavigation; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.from.js */ "./node_modules/core-js/modules/es.array.from.js");
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_string_iterator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.string.iterator.js */ "./node_modules/core-js/modules/es.string.iterator.js");
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _EventBus__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./EventBus */ "./resources/assets/js/utilities/EventBus.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var CollapsibleNavigation = /*#__PURE__*/function () {
  function CollapsibleNavigation() {
    var containerSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-collapsible-navigation]';
    var toggleSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-toggle-navigation]';
    var expandButtonSelector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '[data-expand-navigation]';
    var toggleClassesAttribute = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'data-toggle-classes';
    _classCallCheck(this, CollapsibleNavigation);
    this.containerSelector = containerSelector;
    ...
    this.toggleClassesElements = Array.from(document.querySelectorAll("[".concat(toggleClassesAttribute, "]")));
    this.isCollapsed = false;
    this.cookieName = 'is-navigation-collapsed';
    this._init();
  }
  _createClass(CollapsibleNavigation, [{
    key: "_init",
    value: function _init() {
      var _this = this;
      ...
      this.expandButtons.forEach(function (expandButton) {
    ...
    value: function _collapse() {
      var _this2 = this;
      _EventBus__WEBPACK_IMPORTED_MODULE_15__["default"].publish('closeAllDropdowns');
      this.toggleClassesElements.forEach(function (element) {
        var classNames = element.getAttribute(_this2.toggleClassesAttribute).split(' ');
    ...
    value: function _expand() {
      var _this3 = this;
      this.toggleClassesElements.forEach(function (element) {
        var classNames = element.getAttribute(_this3.toggleClassesAttribute).split(' ');
        classNames.forEach(function (className) {
          if (className === '') return;
    ...
    value: function _setCookie() {
      ...
      var cookieString = "".concat(this.cookieName, "=").concat(this.isCollapsed, "; expires=").concat(expires.toUTCString(), "; path=").concat(this.path, ";");
      document.cookie = cookieString.trim(' ');
    }
  }]);
  return CollapsibleNavigation;
}();
var initCollapsibleNavigation = function initCollapsibleNavigation() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initCopyToClipboard; }
/* harmony export */ });
...
var initCopyToClipboard = function initCopyToClipboard() {
  ...
  _EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('sidebarPanelActivated', function () {
    copyToClipboard.init('[data-copy-to-clipboard="bookmark"]');
  });
};
...
/***/ "./resources/assets/js/utilities/dropdown.js":
/*!***************************************************!*\
  !*** ./resources/assets/js/utilities/dropdown.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initDropdowns; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_symbol_to_primitive_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol.to-primitive.js */ "./node_modules/core-js/modules/es.symbol.to-primitive.js");
/* harmony import */ var core_js_modules_es_symbol_to_primitive_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_to_primitive_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_date_to_primitive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.date.to-primitive.js */ "./node_modules/core-js/modules/es.date.to-primitive.js");
...
var Dropdown = /*#__PURE__*/function () {
  function Dropdown(toggleElement, dropdownElement, nested) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function _init() {
      ...
      this.toggleElement.addEventListener('click', function (e) {
        ...
        if (_this.dropdownElement.classList.contains('collapsed-dropdown') && !_this.nested) {
          _EventBus__WEBPACK_IMPORTED_MODULE_15__["default"].publish('closeAllDropdowns');
        }
        _this.dropdownElement.classList.toggle('hidden');
      });
    }
  }, {
    key: "close",
...
var initDropdowns = function initDropdowns() {
  var toggleAttribute = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'data-toggle-dropdown';
  var dropdownAttribute = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'data-dropdown';
  var toggleElements = Array.from(document.querySelectorAll("[".concat(toggleAttribute, "]")));
  var dropdowns = toggleElements
  // Filter out dropdown toggles without a corresponding dropdown element
  .filter(function (toggleElement) {
    var dropdownElementSelector = "[".concat(dropdownAttribute, "=\"").concat(toggleElement.getAttribute(toggleAttribute), "\"]");
  ...
  .map(function (toggleElement) {
    var dropdownElement = document.querySelector("[".concat(dropdownAttribute, "=\"").concat(toggleElement.getAttribute(toggleAttribute), "\"]"));
    return new Dropdown(toggleElement, dropdownElement, ancestorHasAttribute(dropdownElement, dropdownAttribute));
  });

  // When event is published, close all dropdowns
  _EventBus__WEBPACK_IMPORTED_MODULE_15__["default"].subscribe('closeAllDropdowns', function () {
    dropdowns.forEach(function (dropdown) {
      dropdown.close();
    });
  });
};
var ancestorHasAttribute = function ancestorHasAttribute(element, attribute) {
...
/***/ "./resources/assets/js/utilities/form-submit-on-change.js":
/*!****************************************************************!*\
  !*** ./resources/assets/js/utilities/form-submit-on-change.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initFormSubmitOnChange; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.from.js */ "./node_modules/core-js/modules/es.array.from.js");
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_string_iterator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.string.iterator.js */ "./node_modules/core-js/modules/es.string.iterator.js");
...
var initFormSubmitOnChange = function initFormSubmitOnChange() {
  var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  var selector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-form-submit-on-change]';
  var forms = Array.from(container.querySelectorAll(selector));
  forms.forEach(function (form) {
    ...
    window.Eventbus.$on('updated-select', lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(function () {
      form.submit();
    }, 250));
  });
};
...
/***/ "./resources/assets/js/utilities/toggle-class.js":
/*!*******************************************************!*\
  !*** ./resources/assets/js/utilities/toggle-class.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ registerClassToggles; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
var handleToggle = function handleToggle(e) {
  e.preventDefault();
  var trigger = this;
  var targetSelectors = trigger.getAttribute('data-toggle-class').split('|');
  targetSelectors.forEach(function (targetSelector) {
    var targets = document.querySelectorAll(targetSelector.split(',')[0]);
    var className = targetSelector.includes(',') ? targetSelector.split(',')[1] : 'hidden';
    var triggerClassName = 'active';
...
var registerClassToggles = function registerClassToggles() {
  var toggles = Array.from(document.querySelectorAll('[data-toggle-class]'));
...
/*!***************************************!*\
  ...
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities/copy-to-clipboard */ "./resources/assets/js/utilities/copy-to-clipboard.js");
/* harmony import */ var _utilities_collapsible_navigation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/collapsible-navigation */ "./resources/assets/js/utilities/collapsible-navigation.js");
/* harmony import */ var _utilities_dropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/dropdown */ "./resources/assets/js/utilities/dropdown.js");
/* harmony import */ var _utilities_animated_toggle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/animated-toggle */ "./resources/assets/js/utilities/animated-toggle.js");
/* harmony import */ var _sortable_sortable_init__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sortable/sortable-init */ "./resources/assets/js/sortable/sortable-init.js");
/* harmony import */ var _utilities_form_submit_on_change__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utilities/form-submit-on-change */ "./resources/assets/js/utilities/form-submit-on-change.js");
/* harmony import */ var _forms_fields_vue_fields__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./forms/fields/vue-fields */ "./resources/assets/js/forms/fields/vue-fields.js");
/* harmony import */ var _utilities_toggle_class__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utilities/toggle-class */ "./resources/assets/js/utilities/toggle-class.js");
 ...
 */
(0,_utilities_collapsible_navigation__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_utilities_dropdown__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_utilities_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_utilities_animated_toggle__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-mobile-navigation]', '[data-mobile-navigation-toggle]', {
  animationClass: 'animate-slide-in-nav lg:animate-none'
});
(0,_utilities_form_submit_on_change__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_sortable_sortable_init__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-sortable]');
(0,_utilities_toggle_class__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
__webpack_require__(/*! ./tables/index */ "./resources/assets/js/tables/index.js");
__webpack_require__(/*! ./sortable/sortable-livewire */ "./resources/assets/js/sortable/sortable-livewire.js");
window.vueFieldsRefresh = function (el) {
  return (0,_forms_fields_vue_fields__WEBPACK_IMPORTED_MODULE_6__["default"])(el);
};
}();
/******/ })()
;