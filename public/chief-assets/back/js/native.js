...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('fragment-add', function () {
    livewireComponent.reload();
  });
  ...
  _createClass(_default, [{
    ...
    value: function _activateTriggerElement(element) {
      ...
      element.addEventListener('click', function () {
        ...
        element.parentNode.removeChild(element);
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.publish('fragment-new', element);
      });
    }
  }, {
