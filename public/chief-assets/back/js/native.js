...
/* harmony import */ var _utilities_conditional_fields__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utilities/conditional-fields */ "./resources/assets/js/utilities/conditional-fields.js");
  ...
  new _sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_3__.default({
    ...
    events: {
      sidebarPanelCreated: function sidebarPanelCreated() {
        ...
        (0,_utilities_conditional_fields__WEBPACK_IMPORTED_MODULE_10__.default)();
      }
    }
  });
});
...
/* harmony import */ var _conditional_fields_InputFieldTrigger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./conditional-fields/InputFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/InputFieldTrigger.js");
...
var initConditionalFields = function initConditionalFields() {
  ...
  formgroupElements.forEach(function (formgroupElement) {
    var formgroupName = formgroupElement.getAttribute(formgroupAttribute);
    var formgroupType = formgroupElement.getAttribute(formgroupTypeAttribute);
    var conditionalFieldsData = JSON.parse(formgroupElement.getAttribute(conditionalFieldsDataAttribute)); // If any of the above is not present, don't initialize a conditional field trigger for this formgroup

    if (!formgroupName || !formgroupType || !conditionalFieldsData) return;

    switch (formgroupType) {
      case 'radio':
        new _conditional_fields_RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_3__.default(formgroupName, formgroupElement, conditionalFieldsData);
        break;

      case 'input':
        new _conditional_fields_InputFieldTrigger__WEBPACK_IMPORTED_MODULE_4__.default(formgroupName, formgroupElement, conditionalFieldsData);
        break;

      default:
        console.error("Conditional fields handling for formgroup type ".concat(formgroupType, " not implemented ..."));
    }
  });
};
...
var ConditionalFieldTrigger = /*#__PURE__*/function () {
  ...
  _createClass(ConditionalFieldTrigger, [{
    ...
    value: function _init() {
      ...
      this.element.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_22___default()(function () {
        _this._handle();
      }, 250));
    }
  }, {
    ...
    value: function _hideConditionalFields() {
      ...
      this.conditionalFields.forEach(function (conditionalField) {
        ...
        if (conditionalField.element.hasAttribute(_this2.formgroupToggledByAttribute)) return;
        conditionalField.element.classList.add('hidden');
        conditionalField.element.setAttribute(_this2.formgroupToggledByAttribute, '');
      });
    }
  }, {
    key: "_showConditionalField",
    value: function _showConditionalField(fieldElement) {
      var triggers = fieldElement.getAttribute(this.formgroupToggledByAttribute);
    ...
    value: function _hideConditionalField(fieldElement) {
      var _this3 = this;

      var triggers = fieldElement.getAttribute(this.formgroupToggledByAttribute).split(this.divider);
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_21___default()(triggers)) {
        fieldElement.classList.add('hidden');
      }
    }
  }], [{
    key: "_createConditionalFields",
    value: function _createConditionalFields(conditionalFieldsData) {
      var output = [];

      for (var _i = 0, _Object$entries = Object.entries(conditionalFieldsData); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            key = _Object$entries$_i[0],
            value = _Object$entries$_i[1];

        var conditionalFieldElement = document.querySelector("[data-conditional=\"".concat(key, "\"]"));

        if (!conditionalFieldElement) {
          console.error("Couldn't find formgroup with key ".concat(key, ". Make sure this field exists on this model."));
        } else {
          output.push({
...
/* harmony import */ var _ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ConditionalFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/ConditionalFieldTrigger.js");
...
var InputFieldTrigger = /*#__PURE__*/function (_ConditionalFieldTrig) {
  ...
  _createClass(InputFieldTrigger, [{
    ...
    value: function _handle() {
      ...
      this.conditionalFields.forEach(function (conditionalField) {
        var isConditionalFieldToBeTriggered = conditionalField.values.find(function (value) {
          if (_this.constructor._isValidRegexExpression(value)) {
            return inputElement.value.match(_this.constructor._createRegexFromString(value));
          }
        ...
        if (isConditionalFieldToBeTriggered) {
          _this._showConditionalField(conditionalField.element);
        } else {
          _this._hideConditionalField(conditionalField.element);
        }
      });
    }
  }]);
...
}(_ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_13__.default);
...
/* harmony import */ var _ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ConditionalFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/ConditionalFieldTrigger.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var RadioFieldTrigger = /*#__PURE__*/function (_ConditionalFieldTrig) {
  ...
  _createClass(RadioFieldTrigger, [{
    ...
    value: function _handle() {
      ...
      var radioElements = Array.from(this.element.querySelectorAll('input[type="radio"]'));

      var checkedRadioElement = this.constructor._getCheckedRadioElement(radioElements); // If no radio element was selected on load, return
      ...
      this.conditionalFields.forEach(function (conditionalField) {
        var isConditionalFieldToBeTriggered = conditionalField.values.find(function (value) {
          if (_this.constructor._isValidRegexExpression(value)) {
            return checkedRadioElement.value.match(_this.constructor._createRegexFromString(value));
          }
    ...
    key: "_getCheckedRadioElement",
    value: function _getCheckedRadioElement(radioElements) {
      return radioElements.find(function (radioElement) {
...
}(_ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_14__.default);
...
__webpack_require__(/*! ./utilities/character-count */ "./resources/assets/js/utilities/character-count.js"); // require('./utilities/toggle-fields');
