...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('fragment-new', function (selectionEl) {
        _this._scanForTriggersIn(selectionEl);
      });
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('fragments-new-panel', function (panel) {
    ...
    value: function _handleTrigger(event) {
      ...
      _sidebar_Api__WEBPACK_IMPORTED_MODULE_4__.default.submit('POST', action, {}, function (data) {
        // this.scanForTriggers();
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.publish('fragment-add', data);
      });
    }
  }]);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new _selectFragment__WEBPACK_IMPORTED_MODULE_9__.default(document, fragmentsContainerEl);
  ...
  var fragmentPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_6__.default('[data-sidebar-fragments-edit]', new _sidebar_Container__WEBPACK_IMPORTED_MODULE_5__.default(sidebarContainerEl), {
    onNewPanel: function onNewPanel(panel) {
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.publish('fragments-new-panel', panel);
    },
    onSubmitPanel: function onSubmitPanel() {
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.publish('fragments-submit-panel');
    },
    events: {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('fragment-add', listen);
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('fragments-submit-panel', function () {
    livewireComponent.reload();
  });
  window.Livewire.on('fragmentsReloaded', function () {
    console.log('reloading fragments');
    _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.publish('fragments-reloaded');
  });
  /**
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('fragments-new-panel', function (panel) {
  ...
  _createClass(_default, [{
    ...
    value: function _init() {
      ...
      reloadEvents.forEach(function (event) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.subscribe(event, function () {
          console.log("selectfragment event subscribe: ".concat(event));
    ...
    value: function _activateTriggerElement(element) {
      ...
      element.addEventListener('click', function () {
        ...
        element.parentNode.removeChild(element);
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.publish('fragment-new', selectionElement);
      });
    }
  }, {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var linkPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_2__.default('[data-sidebar-links-edit]', new _sidebar_Container__WEBPACK_IMPORTED_MODULE_1__.default(sidebarContainerEl), {
    ...
    onNewPanel: function onNewPanel() {
  ...
  _createClass(_default, [{
    ...
    value: function _activateNewPanel(id, url) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_6__.default.get(url, newPanelContainer, function (data) {
        ...
        if (_this3.onNewPanel) {
          _this3.onNewPanel(_this3.panels.find(id));
        }
      });
    }
  }, {
