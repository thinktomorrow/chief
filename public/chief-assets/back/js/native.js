...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_1__["default"].subscribe('fragment-new', function (selectionEl) {
        console.log('selection...');

        _this._scanForTriggersIn(selectionEl);
      });
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_1__["default"].subscribe('fragments-new-panel', function (panel) {
    ...
    value: function _handleTrigger(event) {
      ...
      _sidebar_Api__WEBPACK_IMPORTED_MODULE_0__["default"].submit('POST', action, {}, function (data) {
        ...
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_1__["default"].publish('fragment-add', data);
      });
    }
  }]);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var fragmentPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_1__["default"]('[data-sidebar-fragments-edit]', new _sidebar_Container__WEBPACK_IMPORTED_MODULE_0__["default"](sidebarContainerEl), {
    onNewPanel: function onNewPanel(panel) {
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].publish('fragments-new-panel', panel);
    },
    onSubmitPanel: function onSubmitPanel() {
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].publish('fragments-submit-panel');
    },
    events: {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].subscribe('fragment-add', function () {
    livewireComponent.reload();
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].subscribe('fragments-submit-panel', function () {
    livewireComponent.reload();
  });
  window.Livewire.on('fragmentsReloaded', function () {
    _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].publish('fragments-reloaded');
  });
  /**
  ...
  _createClass(_default, [{
    ...
    value: function _init() {
      ...
      reloadEvents.forEach(function (event) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe(event, function () {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('fragments-new-panel', function (panel) {
    ...
    value: function _activateTriggerElement(element) {
      ...
      element.addEventListener('click', function () {
        ...
        element.parentNode.removeChild(element);
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_0__["default"].publish('fragment-new', element);
      });
    }
  }, {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      Object.keys(this.events).forEach(function (key) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_3__["default"].subscribe(key, _this.events[key]);
      });
    }
  }, {
    ...
    value: function _activateNewPanel(id, url) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_0__["default"].get(url, newPanelContainer, function (data) {
        ...
        _this3.panels.add(new _Panel__WEBPACK_IMPORTED_MODULE_1__["default"](id, url, _this3.panels.findActive() ? _this3.panels.findActive() : null, newPanelContainer));
    ...
    store: {
      set: function set(sortable) {
        ...
        fetch(self.endpoint, {
          ...
          _EventBus__WEBPACK_IMPORTED_MODULE_1__["default"].publish('sortable-stored');
        })["catch"](function (error) {
...
/***/ 1:
/*!*********************************************!*\
  !*** multi ./resources/assets/js/native.js ***!
  \*********************************************/
/*! no static exports found */
