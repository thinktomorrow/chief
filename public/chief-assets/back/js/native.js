...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__.default.subscribe('fragmentSelectionElementCreated', function (selectionEl) {
    ...
    value: function _handleTrigger(event) {
      ...
      if (!action) return;
      _sidebar_Api__WEBPACK_IMPORTED_MODULE_3__.default.submit('POST', action, {}, function (data) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__.default.publish('fragmentAdded', data);
      });
    }
  }]);
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    key: "findFragmentsContainer",
    value: function findFragmentsContainer() {
    ...
    value: function _addTriggerElements() {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(fragmentElements)) {
    ...
    value: function _onlyShowClosestTriggerElement() {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(fragmentElements)) return;
    ...
    key: "insertOrderInPanelForm",
    value: function insertOrderInPanelForm(panelElement) {
...
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Api */ "./resources/assets/js/components/sidebar/Api.js");
/* harmony import */ var _Panel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Panel */ "./resources/assets/js/components/sidebar/Panel.js");
/* harmony import */ var _Panels__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Panels */ "./resources/assets/js/components/sidebar/Panels.js");
...
/* harmony import */ var _Components__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Components */ "./resources/assets/js/components/sidebar/Components.js");
/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Container */ "./resources/assets/js/components/sidebar/Container.js");
...
var _default = /*#__PURE__*/function () {
  function _default() {
    ...
    this.components = new _Components__WEBPACK_IMPORTED_MODULE_9__.default(options.components || []);
    this.panels = new _Panels__WEBPACK_IMPORTED_MODULE_7__.default();
    ...
    this.sidebarContainer = new _Container__WEBPACK_IMPORTED_MODULE_10__.default(options.sidebarContainer || document.getElementById('js-sidebar-container'));
    ...
    if (this.debug) {
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.debug = true;
    }

    this.listenForEvents();
    this.listenForLivewireEvents();
    this.listenForEscapeKey(); // Subscribe events via the global EventBus

    if (options.events) {
      Object.keys(options.events).forEach(function (key) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.subscribe(key, options.events[key]);
      });
    }

    if (options.reloadEvents) {
      options.reloadEvents.forEach(function (eventKey) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.subscribe(eventKey, _this.listenForEvents.bind(_this));
      });
    }
  }
  ...
  _createClass(_default, [{
    ...
    value: function listenForLivewireEvents() {
      ...
      this.components.allIn(this.currentContainer()).forEach(function (component) {
        ...
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('sidebarFormSubmitted', function (panelData) {
    ...
    value: function show(url, triggerData) {
      var id = _Panels__WEBPACK_IMPORTED_MODULE_7__.default.createId(url); // if present in panels, than show the existing panel.
    ...
    value: function _activateNewPanel(id, url, triggerData) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_5__.default.get(url, function (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_5__.default.listenForFormSubmits(newPanelElement, function () {
        ...
        _this4.panels.add(new _Panel__WEBPACK_IMPORTED_MODULE_6__.default(id, url, _this4.panels.findActive() ? _this4.panels.findActive() : null, newPanelElement, triggerData));

        _this4._activate(id);

        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.publish('sidebarPanelCreated', _this4.panels.findActive().eventPayload());
      });
    }
  }, {
    key: "_activate",
    ...
    value: function reset() {
      ...
      this.replacePanelComponents(function () {
        ...
        if (_this5.panels.findActive()) {
          _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.publish('sidebarPanelActivated', _this5.panels.findActive().eventPayload());
        }
      });
    }
  }, {
    ...
    value: function replacePanelComponents(callback) {
      var _this8 = this;
      ...
      _Api__WEBPACK_IMPORTED_MODULE_5__.default.get(this.panels.findActive().url, function (data) {
...
/* harmony import */ var _utilities_Collection__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities/Collection */ "./resources/assets/js/utilities/Collection.js");
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   */
  var loadedSelectFragments = new _utilities_Collection__WEBPACK_IMPORTED_MODULE_8__.default();
  var fragmentsComponent = new _sidebar_Component__WEBPACK_IMPORTED_MODULE_3__.default('fragments', {
    ...
    events: {
      sidebarPanelCreated: function sidebarPanelCreated(panelData) {
        console.log('sidebar fragments panel created for ' + panelData.panel.id); // Build the select fragment elements for the nested fragments components inside the panel
      ...
      sidebarPanelActivated: function sidebarPanelActivated(panelData) {
        ...
        var currentSelectFragment = new _fragment_selectFragment__WEBPACK_IMPORTED_MODULE_5__.default(panelData.panel.el, {
        ...
        if (currentSelectFragment.exists()) {
          loadedSelectFragments.add({
            id: panelData.panel.id,
            class: currentSelectFragment
          });
    ...
    onComponentCreation: function onComponentCreation() {
      loadedSelectFragments.clear().add({
        id: 0,
        class: new _fragment_selectFragment__WEBPACK_IMPORTED_MODULE_5__.default(document)
      });
      (0,_fragment_sortableFragments__WEBPACK_IMPORTED_MODULE_6__.default)();
    },
  ...
  new _sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_2__.default({
    ...
    events: {
      ...
      sidebarFormSubmitted: function sidebarFormSubmitted() {// form submit -> component die dit panel getrigged heeft moeten we refreshen.
...
IndexSorting.prototype._init = function () {
  ...
  var self = this;
  this.Sortables.push(sortablejs__WEBPACK_IMPORTED_MODULE_7__.default.create(this.sortableGroupEl, {
    group: 'models',
    fallbackOnBody: true,
    swapThreshold: 0.65,
    ...
    store: {
      set: function set(sortable) {
        ...
        fetch(self.endpoint, {
          ...
          _EventBus__WEBPACK_IMPORTED_MODULE_8__.default.publish('sortableStored');
        }).catch(function (error) {
