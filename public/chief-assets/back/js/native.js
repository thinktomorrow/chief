...
document.addEventListener('DOMContentLoaded', function () {
   ...
   */
  var loadedSelectFragments = new _utilities_Collection__WEBPACK_IMPORTED_MODULE_9__.default();
  var fragmentsComponent = new _sidebar_Component__WEBPACK_IMPORTED_MODULE_4__.default('fragments', {
    ...
    events: {
      ...
      sidebarPanelActivated: function sidebarPanelActivated(panelData) {
        ...
        var currentSelectFragment = new _fragment_selectFragment__WEBPACK_IMPORTED_MODULE_6__.default(panelData.panel.el, {
    ...
    onComponentCreation: function onComponentCreation() {
      loadedSelectFragments.clear().add({
        id: 0,
        class: new _fragment_selectFragment__WEBPACK_IMPORTED_MODULE_6__.default(document)
      });
  ...
  new _sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_3__.default({
    debug: true,
    components: [linksComponent, statusComponent, fragmentsComponent, fragmentSelectionComponent].concat(fieldComponents),
