...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initSortable": function() { return /* binding */ initSortable; }
/* harmony export */ });
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_array_from_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.from.js */ "./node_modules/core-js/modules/es.array.from.js");
  ...
  function _default(key, options) {
    ...
    if (options.events) {
      Object.keys(options.events).forEach(function (key) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_2__.default.subscribe(key, function (panelData) {
    ...
    this.onComponentReloadEvent = options.onComponentReload || (options.onComponentCreation ? options.onComponentCreation : function () {});
  }
  /**
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function _activateNewPanel(id, url, triggerData) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_5__.default.get(url, newPanelElement, function (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_5__.default.listenForFormSubmits(newPanelElement, function (response) {
    ...
    value: function _activate(id) {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_8__.default.publish('sidebarPanelActivated', this.panels.findActive().eventPayload()); // TODO: pass here type to switch templates x/terug/...
    ...
    value: function _setActiveComponents() {
      ...
      this.components.all().forEach(function (component) {
        if (component.el(container)) {
          _this5.components.addAsActive(component.key);
        }
      });
    }
    /**
    ...
    value: function backOrClose() {
      ...
      console.log(this.panels.findActive()); // Back to parent
    ...
    value: function replacePanelComponents() {
      ...
      Array.from(this.panels.findActive().el.querySelectorAll('[data-sidebar-component]')).forEach(function (el) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_5__.default.get(_this7.panels.findActive().url, el, function (data) {
          var DOM = document.createElement('div');
          DOM.innerHTML = data;

          _this7.panels.activePanel.replaceDom("[data-sidebar-component=\"".concat(componentKey, "\"]"), DOM.querySelector("[data-sidebar-component=\"".concat(componentKey, "\"]")).innerHTML);

          _this7.listenForEvents();
        });
      });
    }
  }]);
