...
/* harmony import */ var _sortable_sortable_init__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../sortable/sortable-init */ "./resources/assets/js/sortable/sortable-init.js");
...
Form.prototype.listen = function () {
  ...
  Array.from(this.el.querySelectorAll(this.triggerSelector)).forEach(function (trigger) {
    ...
    _this2.addTag(_sidebar_Panels__WEBPACK_IMPORTED_MODULE_10__["default"].createId(trigger.getAttribute('href')));
...
Form.prototype.refresh = function () {
  ...
  _Api__WEBPACK_IMPORTED_MODULE_11__["default"].get(url, function (data) {
    ...
    DOM.innerHTML = data;
    _this3.el.innerHTML = DOM.firstElementChild.innerHTML; // Mount Vue on our vue specific fields. Make sure that Vue mount occurs
    // before vanilla event listeners so native js can do its thing

    (0,_fields_vue_fields__WEBPACK_IMPORTED_MODULE_12__["default"])(_this3.el); // So Redactor can be reinitialised when the form is refreshed
...
Form.prototype.refreshCallback = function () {
  (0,_sortable_sortable_init__WEBPACK_IMPORTED_MODULE_13__["default"])('[data-sortable]', this.el);
...
var Forms = function Forms(mainContainer, sidebar) {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('chief-form-submitted', function (e) {
    ...
    _this.refreshIn(targetElement, e.tags);
  });
...
/* harmony import */ var _ConditionalFieldTrigger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ConditionalFieldTrigger */ "./resources/assets/js/forms/conditional-fields/ConditionalFieldTrigger.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
/* harmony import */ var _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utilities/EventBus */ "./resources/assets/js/utilities/EventBus.js");
/* harmony import */ var _RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RadioFieldTrigger */ "./resources/assets/js/forms/conditional-fields/RadioFieldTrigger.js");
/* harmony import */ var _SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SelectFieldTrigger */ "./resources/assets/js/forms/conditional-fields/SelectFieldTrigger.js");
...
/* harmony import */ var _InputFieldTrigger__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./InputFieldTrigger */ "./resources/assets/js/forms/conditional-fields/InputFieldTrigger.js");
...
var initConditionalFieldsInContainer = function initConditionalFieldsInContainer() {
  ...
  formgroupElements.forEach(function (element) {
    ...
    switch (type) {
      case 'radio':
        new _RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_5__["default"](name, element, conditionalFieldsData);
        break;

      case 'select':
        new _SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_6__["default"](name, element, conditionalFieldsData);
        break;
      ...
      case 'input':
        new _InputFieldTrigger__WEBPACK_IMPORTED_MODULE_8__["default"](name, element, conditionalFieldsData);
        break;
...
Repeat.prototype.insertSection = function (sectionHtml) {
  ...
  var lastSection = sections[sections.length - 1]; // Place after last section - if no section present yet, add it as the first section in the container
...
Repeat.prototype.order = function () {
  ...
  this.getSections().forEach(function (section) {
    ...
    Array.from(section.querySelectorAll("[name^=\"".concat(_this4.prefix, "[\"]"))) // .filter((_el) => _el.closest(this.containerSelector) === this.container)
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function findFirstSubmitTarget(panel) {
      if (!panel) return null; // This is a bit too hardcoded... This makes sure we don't go back to any create pages after submission
...
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Api */ "./resources/assets/js/forms/Api.js");
/* harmony import */ var _Panel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Panel */ "./resources/assets/js/forms/sidebar/Panel.js");
/* harmony import */ var _Panels__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Panels */ "./resources/assets/js/forms/sidebar/Panels.js");
/* harmony import */ var _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utilities/EventBus */ "./resources/assets/js/utilities/EventBus.js");
/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Container */ "./resources/assets/js/forms/sidebar/Container.js");
/* harmony import */ var _fields_vue_fields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../fields/vue-fields */ "./resources/assets/js/forms/fields/vue-fields.js");
...
var _default = /*#__PURE__*/function () {
  function _default() {
    ...
    this.panels = new _Panels__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this.sidebarContainer = new _Container__WEBPACK_IMPORTED_MODULE_7__["default"](document.getElementById('js-sidebar-container'));
    /**
  ...
  _createClass(_default, [{
    ...
    value: function show(url) {
      ...
      var id = _Panels__WEBPACK_IMPORTED_MODULE_5__["default"].createId(url);
    ...
    value: function fetchUrl(url) {
      ...
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var panelId = _Panels__WEBPACK_IMPORTED_MODULE_5__["default"].createId(url); // Add a new panel element to dom
      ...
      _Api__WEBPACK_IMPORTED_MODULE_3__["default"].get(url, function (data) {
        ...
        (0,_fields_vue_fields__WEBPACK_IMPORTED_MODULE_8__["default"])(panelEl); // TODO: refactor to trigger submit.js for panel submissions...
        ...
        _this3.panels.add(new _Panel__WEBPACK_IMPORTED_MODULE_4__["default"](panelId, url, _this3.panels.findActive() ? _this3.panels.findActive() : null, panelEl, options));

        _this3.showPanel(panelId);

        _this3.refresh(); // Creating a custom event so native js like redactor js can be initiated async
        ...
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__["default"].publish('sidebarPanelCreated', {
          panel: _this3.panels.findActive()
        });
      });
    }
    ...
    value: function refresh() {
      ...
      this.replacePanelComponents(function () {
        ...
        if (_this5.panels.findActive()) {
          _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__["default"].publish('sidebarPanelActivated', {
    ...
    value: function replacePanelComponents(callback, data) {
      ...
      if (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_3__["default"].get(this.panels.findActive().url, function (_data) {
...
/* harmony import */ var _sortable__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sortable */ "./resources/assets/js/sortable/sortable.js");
...
var initSortable = function initSortable(selector) {
  ...
  Array.from(container.querySelectorAll(selector)).forEach(function (el) {
    new _sortable__WEBPACK_IMPORTED_MODULE_9__["default"](_objectSpread(_objectSpread({}, {
      sortableGroupEl: el,
...
var SortableGroup = function SortableGroup(options) {
  this.Sortables = [];
...
SortableGroup.prototype._init = function () {
  ...
  this.Sortables.push(sortablejs__WEBPACK_IMPORTED_MODULE_6__["default"].create(this.sortableGroupEl, {
    ...
    onEnd: function onEnd(evt) {
      ...
      if (!self.nestedEndpoint) return; // if the parent is the same DOM element - we abort here.
...
var BulkActions = /*#__PURE__*/function () {
  function BulkActions() {
    ...
    if (!this.parentCheckbox || lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(this.itemCheckboxes)) return;
  ...
  _createClass(BulkActions, [{
    ...
    value: function _init() {
      ...
      this.parentCheckbox.addEventListener('change', function () {
        ...
        _this._toggleBulkActionsContainer(count);
...
/* harmony import */ var _EventBus__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./EventBus */ "./resources/assets/js/utilities/EventBus.js");
...
var CollapsibleNavigation = /*#__PURE__*/function () {
  ...
  _createClass(CollapsibleNavigation, [{
    ...
    value: function _collapse() {
      ...
      _EventBus__WEBPACK_IMPORTED_MODULE_8__["default"].publish('closeAllDropdowns');
    ...
    value: function _init() {
      ...
      this.toggleElement.addEventListener('click', function (e) {
        ...
        if (_this.dropdownElement.classList.contains('collapsed-dropdown') && !_this.nested) {
          _EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].publish('closeAllDropdowns');
        }
...
var initDropdowns = function initDropdowns() {
  ...
  var dropdowns = toggleElements // Filter out dropdown toggles without a corresponding dropdown element
  ...
  _EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].subscribe('closeAllDropdowns', function () {
...
/*!***************************************!*\
  ...
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sortable_sortable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sortable/sortable */ "./resources/assets/js/sortable/sortable.js");
/* harmony import */ var _utilities_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/copy-to-clipboard */ "./resources/assets/js/utilities/copy-to-clipboard.js");
/* harmony import */ var _utilities_collapsible_navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/collapsible-navigation */ "./resources/assets/js/utilities/collapsible-navigation.js");
/* harmony import */ var _utilities_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/dropdown */ "./resources/assets/js/utilities/dropdown.js");
/* harmony import */ var _utilities_animated_toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilities/animated-toggle */ "./resources/assets/js/utilities/animated-toggle.js");
/* harmony import */ var _sortable_sortable_init__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sortable/sortable-init */ "./resources/assets/js/sortable/sortable-init.js");
...
(0,_utilities_collapsible_navigation__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_utilities_dropdown__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_utilities_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_utilities_animated_toggle__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-mobile-navigation]', '[data-mobile-navigation-toggle]', {
...
(0,_sortable_sortable_init__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-sortable]'); // Support for specific sorting index

if (document.getElementById('js-sortable')) {
  new _sortable_sortable__WEBPACK_IMPORTED_MODULE_0__["default"]({
    // any options go here
