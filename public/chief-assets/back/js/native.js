...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function closeAll() {
      this.container.querySelectorAll(this.elementSelector).forEach(function (element) {
    ...
    value: function _addOrderToExistingFragmentLink(element) {
      ...
      element.querySelectorAll('[data-sidebar-trigger]').forEach(function (el) {
        if (el.hasAttribute('href')) {
          el.setAttribute('href', _this3._getUriWithParam(el.getAttribute('href'), {
            order: order
          }));
        }
      });
  ...
  _createClass(_default, [{
    ...
    value: function _activateNewPanel(id, url, triggerData) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_15__.default.get(url, function (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_15__.default.listenForFormSubmits(newPanelElement, function (responseData) {
          // Reset any error
    ...
    value: function replacePanelComponents(callback) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_15__.default.get(this.panels.findActive().url, function (data) {
