...
Form.prototype.listen = function () {
  ...
  _Api__WEBPACK_IMPORTED_MODULE_9__["default"].listenForFormSubmits(this.el, this.onFormSubmission.bind(this), function (error) {
    console.error("".concat(error));
  });
};

Form.prototype.onFormSubmission = function (responseData) {
  _Submit__WEBPACK_IMPORTED_MODULE_13__["default"].handle(responseData, this.el, this.mainContainer, this.getTags());
};
...
Form.prototype.refresh = function () {
  ...
  _Api__WEBPACK_IMPORTED_MODULE_9__["default"].get(url, function (data) {
    ...
    (0,_fields_vue_fields__WEBPACK_IMPORTED_MODULE_10__["default"])(_this2.el); // TODO: this method is now coming from project code (project skeleton),
    ...
    _utilities_EventBus__WEBPACK_IMPORTED_MODULE_14__["default"].publish('form-refreshed', {
      element: _this2.el
    });
...
var Submit = {
  handle: function handle(responseData, currentElement, targetElement, tags, successCallback) {
    // Reset any error
...
/* harmony import */ var _Submit__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Submit */ "./resources/assets/js/forms/Submit.js");
  ...
  _createClass(_default, [{
    ...
    value: function fetchUrl(url) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_3__["default"].get(url, function (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_3__["default"].listenForFormSubmits(panelEl, _this3.onFormSubmission.bind(_this3), function (error) {
          console.error("".concat(error));
        });
    ...
    value: function onFormSubmission(responseData, metadata) {
      ...
      _Submit__WEBPACK_IMPORTED_MODULE_9__["default"].handle(responseData, activePanel.el, targetPanel ? targetPanel.el : document, activePanel.getTags(), function () {
        // GET request stays on same page and reloads it with the given response.
        if (metadata.method === 'get') {
          _this4.refresh(responseData);

          return;
        }

        _this4.backAfterSubmit();
      });
    }
  }, {
    key: "backAfterSubmit",
...
var initCharacterCount = function initCharacterCount() {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_7__["default"].subscribe('form-refreshed', function (data) {
...
var initUnsavedNotifications = function initUnsavedNotifications(formSelector) {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe('form-refreshed', function (data) {
