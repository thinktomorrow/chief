...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function close() {
      ...
      Promise.all([this._closeElement(this.sidebarBackdrop, 'fade-in'), this._closeElement(this.sidebarContent, 'slide-from-right')]).then(function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var fragmentPanelsManager = new _PanelsManager__WEBPACK_IMPORTED_MODULE_1__["default"]('[data-sidebar-fragment-edit]', new _Container__WEBPACK_IMPORTED_MODULE_0__["default"](sidebarContainerEl), function (panel) {
