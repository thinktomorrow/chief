...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Array.from(componentEls).forEach(function (el) {
    ...
    var linkPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_6__.default("[".concat(el.getAttribute('data-fields-component'), "]"), new _sidebar_Container__WEBPACK_IMPORTED_MODULE_5__.default(sidebarContainerEl), {
...
/* harmony import */ var _sidebar_Api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../sidebar/Api */ "./resources/assets/js/components/sidebar/Api.js");
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('fragmentSelectionElementCreated', function (selectionEl) {
        _this._scanForTriggersIn(selectionEl);
      });
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('newFragmentPanelCreated', function (panel) {
    ...
    value: function _handleTrigger(event) {
      ...
      if (!action) return;
      _sidebar_Api__WEBPACK_IMPORTED_MODULE_4__.default.submit('POST', action, {}, function (data) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_5__.default.publish('fragmentAdded', data);
      });
    }
  }]);
...
var initSortable = function initSortable() {
  ...
  Array.from(container.querySelectorAll(selector)).forEach(function (el) {
    new _utilities_sortable__WEBPACK_IMPORTED_MODULE_7__.default(_objectSpread(_objectSpread({}, {
      sortableGroupEl: el,
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('newFragmentPanelCreated', function (panel) {
    ...
    new _selectFragment__WEBPACK_IMPORTED_MODULE_8__.default(panel.el);
  });
...
var initFragments = function initFragments() {
  ...
  new _selectFragment__WEBPACK_IMPORTED_MODULE_8__.default(document);
  var fragmentPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_6__.default('[data-sidebar-fragments-edit]', new _sidebar_Container__WEBPACK_IMPORTED_MODULE_5__.default(sidebarContainerElement), {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('fragmentAdded', function () {
...
var _default = /*#__PURE__*/function () {
  function _default(container) {
    var fragmentsContainerSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-fragments-container]';
  ...
  _createClass(_default, [{
    ...
    value: function _init() {
      ...
      reloadEvents.forEach(function (event) {
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__.default.subscribe(event, function () {
          // Needs to be redefined after Livewire rebuild the element with the added fragment
          _this.fragmentsContainer = _this.container.querySelector(_this.fragmentsContainerSelector);
      ...
      _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__.default.subscribe('newFragmentPanelCreated', function (panel) {
    ...
    value: function _addTriggerElements() {
      ...
      var fragmentElements = Array.from(this.fragmentsContainer.querySelectorAll(this.fragmentSelector)); // Add a selection element instead if no fragments exist yet

      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(fragmentElements)) {
        var newSelectionElement = this._createSelectionElement(false);

        this.fragmentsContainer.appendChild(newSelectionElement);
        _utilities_EventBus__WEBPACK_IMPORTED_MODULE_6__.default.publish('fragmentSelectionElementCreated', newSelectionElement);
        return;
      ...
      fragmentElements.forEach(function (element, index) {
        ...
        _this2.fragmentsContainer.insertBefore(triggerElement, element); // Also add a trigger element after the last fragment element
    ...
    value: function _onlyShowClosestTriggerElement() {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(fragmentElements)) return;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var fragmentSelectionPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_2__.default(fragmentSelectionSidebarTriggerSelector, new _sidebar_Container__WEBPACK_IMPORTED_MODULE_1__.default(sidebarContainerElement), {
    newPanelCreated: function newPanelCreated(panel) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var linkPanelsManager = new _sidebar_PanelsManager__WEBPACK_IMPORTED_MODULE_2__.default('[data-sidebar-links-edit]', new _sidebar_Container__WEBPACK_IMPORTED_MODULE_1__.default(sidebarContainerEl), {
    panelFormSubmitted: function panelFormSubmitted() {
      livewireComponent.reload();
    },
    newPanelCreated: function newPanelCreated() {
      console.log('triggered...'); // Trigger js for submit form elements (these are used for the state transitions)

      _utilities_form_submit__WEBPACK_IMPORTED_MODULE_3__.default.listen('[data-submit-form]', sidebarContainerEl);
    },
    events: {// 'fragmentSelectionElementCreated': () => {
      //
      // },
  ...
  window.Livewire.on('linksReloaded', function () {
    linkPanelsManager.scanForPanelTriggers();
  });
});
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    key: "scanForCloseTriggers",
    value: function scanForCloseTriggers() {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Api */ "./resources/assets/js/components/sidebar/Api.js");
/* harmony import */ var _Panel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Panel */ "./resources/assets/js/components/sidebar/Panel.js");
/* harmony import */ var _Panels__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Panels */ "./resources/assets/js/components/sidebar/Panels.js");
/* harmony import */ var _utilities_EventBus__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../utilities/EventBus */ "./resources/assets/js/utilities/EventBus.js");
...
var _default = /*#__PURE__*/function () {
  function _default(triggerSelector, container, options) {
    ...
    this.container = container;
    this.panels = new _Panels__WEBPACK_IMPORTED_MODULE_8__.default();
  ...
  _createClass(_default, [{
    ...
    value: function scanForPanelTriggers() {
      ...
      this.container.closeTriggers.forEach(function (trigger) {
        trigger.removeEventListener('click', _this2.backOrClose.bind(_this2));
        trigger.addEventListener('click', _this2.backOrClose.bind(_this2));
      });
    }
  }, {
    key: "_handlePanelTrigger",
    value: function _handlePanelTrigger(event) {
      event.preventDefault();
      var link = event.target.hasAttribute('href') ? event.target : event.target.closest('[href]');
      if (!link) return;
      this.show(link.getAttribute('href'));
    }
  }, {
    key: "_handlePanelCloseTrigger",
    value: function _handlePanelCloseTrigger(event) {
      event.preventDefault();
      var link = event.target.hasAttribute('href') ? event.target : event.target.closest('[href]');
      if (!link) return;
      this.show(link.getAttribute('href'));
    ...
    value: function show(url) {
      var id = _Panels__WEBPACK_IMPORTED_MODULE_8__.default.createId(url); // if present in panels, than show the existing panel.
    ...
    value: function _activateNewPanel(id, url) {
      ...
      _Api__WEBPACK_IMPORTED_MODULE_6__.default.get(url, newPanelContainer, function (data) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_6__.default.listenForFormSubmits(newPanelContainer, function (response) {
          console.log('success', response);

          _this3.backOrClose(false);

          if (_this3.panelFormSubmitted) {
            _this3.panelFormSubmitted();
          }
        }, function (error) {
        ...
        if (!_this3.container.isOpen()) {
          _this3.container.open();
        }

        _this3.panels.add(new _Panel__WEBPACK_IMPORTED_MODULE_7__.default(id, url, _this3.panels.findActive() ? _this3.panels.findActive() : null, newPanelContainer));

        _this3._activate(id);

        if (_this3.newPanelCreated) {
          _this3.newPanelCreated(_this3.panels.find(id));
        }
      });
    }
  }, {
