...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function listen() {
    console.log("livewire comp. ".concat(componentEl.getAttribute('wire:id'), " reloaded."));
    livewireComponent.reload();
  }
...
var _default = /*#__PURE__*/function () {
  function _default(container, fragmentsContainerSelector) {
    _classCallCheck(this, _default);
  ...
  _createClass(_default, [{
    ...
    value: function _addTriggerElements() {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(fragmentElements)) {
        var newSelectionElement = this._createSelectionElement();
