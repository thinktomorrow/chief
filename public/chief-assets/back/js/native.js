...
/* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Form */ "./resources/assets/js/forms/Form.js");
...
var Forms = function Forms(sidebar) {
  ...
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_2__["default"].subscribe('chief-form-submitted', function (e) {
    // TODO: not always is currentElement a panel...
    _this.refreshIn(e.targetElement, e.tags);
  });
  _utilities_EventBus__WEBPACK_IMPORTED_MODULE_2__["default"].subscribe('sidebarPanelActivated', function (e) {
...
Forms.prototype.load = function () {
  ...
  container.querySelectorAll(this.selector).forEach(function (el) {
    new _Form__WEBPACK_IMPORTED_MODULE_3__["default"](el, _this2.sidebar).refreshCallback();
  });
};
...
Forms.prototype.listenIn = function () {
  ...
  var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  container.querySelectorAll(this.selector).forEach(function (el) {
    new _Form__WEBPACK_IMPORTED_MODULE_3__["default"](el, _this3.sidebar).listen();
  });
};
...
/* harmony import */ var _EventBus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./EventBus */ "./resources/assets/js/utilities/EventBus.js");
...
_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].subscribe('form-refreshed', function (data) {
  data.element.querySelectorAll('[data-character-count]').forEach(function (el) {
    characterCount(data.element, el);
  });
});
_EventBus__WEBPACK_IMPORTED_MODULE_5__["default"].subscribe('sidebarPanelActivated', function (data) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _conditional_fields_RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./conditional-fields/RadioFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/RadioFieldTrigger.js");
/* harmony import */ var _conditional_fields_SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./conditional-fields/SelectFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/SelectFieldTrigger.js");
/* harmony import */ var _conditional_fields_CheckboxFieldTrigger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./conditional-fields/CheckboxFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/CheckboxFieldTrigger.js");
/* harmony import */ var _conditional_fields_InputFieldTrigger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./conditional-fields/InputFieldTrigger */ "./resources/assets/js/utilities/conditional-fields/InputFieldTrigger.js");
...
var initConditionalFields = function initConditionalFields() {
  ...
  formgroupElements.forEach(function (element) {
    ...
    switch (type) {
      case 'radio':
        new _conditional_fields_RadioFieldTrigger__WEBPACK_IMPORTED_MODULE_4__["default"](name, element, conditionalFieldsData);
        break;

      case 'select':
        new _conditional_fields_SelectFieldTrigger__WEBPACK_IMPORTED_MODULE_5__["default"](name, element, conditionalFieldsData);
        break;

      case 'checkbox':
        new _conditional_fields_CheckboxFieldTrigger__WEBPACK_IMPORTED_MODULE_6__["default"](name, element, conditionalFieldsData);
        break;

      case 'textinput':
      case 'input':
        new _conditional_fields_InputFieldTrigger__WEBPACK_IMPORTED_MODULE_7__["default"](name, element, conditionalFieldsData);
        break;
