<template>
    <div class="pagebuilder-menu show-on-hover center-y">
        ...
        <div v-show="active" class="pagebuilder-menu-items bg-white squished --raised rounded flex inline-group-l">
            ...
            <div class="flex flex-col">
                ...
                <div class="inline-group-s">
                    <div class="left pointer">
                        <span title="pagina titel toevoegen" @click="addingNewPagetitleSectionAfter(section.sort)" class="label label-o--secondary center-y">
                    ...
                    <div class="left pointer" @click="addingNewTextSectionAfter(section.sort)">
                        <span title="tekst / afbeelding toevoegen" class="label label-o--secondary center-y">
                            <i class="icon icon-align-left"></i>
                            Tekstblok
                        </span>
                    </div>
