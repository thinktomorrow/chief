<x-chief::dialog.modal id="refresh-modal" title="Je sessie is verlopen" size="xs" class="z-1000!">
...
<x-chief::dialog.modal id="error-modal" title="Er is iets misgelopen" size="xs" class="z-1000!">
    <div class="prose prose-dark prose-spacing">
        <p>
