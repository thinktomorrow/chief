    ...
    <template id="js-sidebar-template">
        <div data-sidebar class="fixed inset-0" style="z-index: 50; display: none;">
            <div
                ...
                data-sidebar-close
                class="absolute inset-0 bg-black opacity-25 cursor-pointer fade-in"
            ></div>

            <aside
                data-sidebar-aside
                class="absolute top-0 right-0 bottom-0 bg-white shadow-soft p-12 space-y-4 overflow-auto w-1/2 2xl:w-1/3 slide-from-right"
            >
                <div
                    data-sidebar-close
