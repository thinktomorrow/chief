<section class="row formgroup gutter-xs">
    <div class="column-4">
        ...
        <p class="caption">De officiële naam van het bedrijf.</p>
    </div>
...
<section class="row formgroup gutter-xs">
    <div class="column-4">
        ...
        <p class="caption">Het adres waar het bedrijf gevestigd is.</p>
    </div>
    <div class="formgroup-input column-8">
        <div class="stack-s">
...
<section class="row formgroup gutter-xs">
    <div class="column-4">
        <h2 class="formgroup-label">Contactgegevens</h2>
        <p class="caption">De contactgegevens van het bedrijf.</p>
    </div>
    <div class="formgroup-input column-8">
        <div class="stack">
            <label for="company-telephone">Telefoonnummer</label>
            <input type="text" name="company-telephone" id="company-telephone" class="input inset-s" placeholder="Telefoonnummer">
        </div>
        <div class="stack">
            <label for="company-cellphone">GSM-nummer</label>
            <input type="text" name="company-cellphone" id="company-cellphone" class="input inset-s" placeholder="GSM-nummer">
        </div>
        <div class="stack">
            <label for="company-mail">E-mail</label>
...
<section class="row formgroup gutter-xs">
    <div class="column-4">
        <h2 class="formgroup-label">Bedrijfs data</h2>
        <p class="caption">De BTW-nummer van het bedrijf.</p>
    </div>
    <div class="formgroup-input column-8">
