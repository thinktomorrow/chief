		...
		<aside class=" col-md-3">
			<div class="panel">
				...
				<div class="panel-footer">
					<a class="subtle pull-left mt10" id="remove-article-toggle" href="{{ URL::previous() }}"><i
								class="fa fa-long-arrow-left"></i> Terug</a>
					<div class="text-right">
						<button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> Publiceer artikel
						</button>
					</div>
				</div>
			</div>
