<modal id="publication-now-article">
    <div v-cloak>
        <div class="column-12">
            <h2 class="formgroup-label">Super. Tijd om je artikel te publiceren. 👍</h2>
            ...
            <div class="stack inline-group">
                <a class="btn btn-primary">Publiceer het artikel</a>
                <a class="btn btn-o-secondary">Plan het in</a>
