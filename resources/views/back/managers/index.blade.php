                ...
                <div class="window window-white">
                    @adminCan('sort-index')
                        <div
                            ...
                            class="relative divide-y divide-grey-150 border-t border-b border-grey-150 -m-12"
                        >
                    @elseAdminCan
                        <div class="relative divide-y divide-grey-150 border-t border-b border-grey-150 -m-12">
                    @endAdminCan
