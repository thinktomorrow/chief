                    ...
                    @foreach($page->availableLocales() as $locale)
                        ...
                        <tab name="{{ $locale }}" :options="{ hasErrors: errors.has('trans.{{ $locale }}.title')}">
                            <div class="stack-s">
                                ...
                                <span class="stack text-default"><b>Permalink:</b> https://crius-group.com/<b><input type="text" name="trans[{{$locale}}][slug]" value="paginanaam"></b><button>edit</button></span>
                            ...
                            <div class="stack">
                                ...
                                <textarea class="inset-s" name="trans[{{ $locale }}][description]" id="trans-{{ $locale }}-description" cols="10" rows="5">{{ old('trans.'.$locale.'.content',$page->translateForForm($locale,'content')) }}</textarea>
                            </div>
