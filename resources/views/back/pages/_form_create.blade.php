<tabs>
    <tab name="Inhoud">
        ...
        @include('chief::back._elements.mediagroup', ['group' => \Thinktomorrow\Chief\Media\MediaType::HERO, 'label' => 'hoofdafbeelding', 'description' => 'Dit is de afbeelding die wordt getoond bovenaan de pagina.'])
