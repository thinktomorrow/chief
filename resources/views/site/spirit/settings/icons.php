...
<section class="column stack-l iconography" id="iconography">
  <h1>Iconography</h1>
  <hr>
  <h2>Feather icons-Free font</h2>
  <ul class="row glyphs css-mapping">
      <li class="column-3 squished">
      ...
      <li class="column-3 squished">
          <span class="icon-comment-circle"></span>
          <span class="mls"> icon-comment-circle</span>
      </li>
      <li class="column-3 squished">
          <span class="icon-comment-square"></span>
          <span class="mls"> icon-comment-square</span>
      </li>
      <li class="column-3 squished">
