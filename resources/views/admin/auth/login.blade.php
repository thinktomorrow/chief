...
@section('content')
    <div class="container">
        ...
        <div class="relative row-center-center min-h-screen">
            <div class="w-full lg:w-1/2 2xl:w-2/5 window window-white prose prose-dark">
                <h1>Welkom terug, Chief!</h1>

                <form id="valid" role="form" method="POST" action="{{ route('chief.back.login.store') }}" class="space-y-12">
                    {{ csrf_field() }}
                    ...
                    <div class="space-y-6">
                        ...
                        <label for="rememberCheckbox" class="flex items-center space-x-2 cursor-pointer with-custom-checkbox">
