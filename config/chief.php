...
//    ],
    ...
    'sites' => [
        'nl' => [
            ...
            /**
             * Indicates if this site is active on frontend. The site will be
             * available in the admin but not on the frontend if set to false.
             */
            'active' => true,
            ...
            /**
             * Frontend url of the site. This is the root url of the site. Note that this does not
             * generates the routes but is only in the Chief admin for referencing the correct
             * site. Frontend routes are generated by e.g. the thinktomorrow/locale package.
             */
