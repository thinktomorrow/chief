...
class Form extends Component
{
    ...
    protected string $view = 'chief-forms::forms.form';
    protected string $windowView = 'chief-forms::forms.form-window';
     ...
     */
    protected string $windowContainerView = 'chief-forms::forms.form-window-container';
