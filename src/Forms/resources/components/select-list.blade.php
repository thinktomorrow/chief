...
<div
    ...
    <ol
        ...
        <button type="button" x-show="$data.allowSelectBox && !$data.showingSelectBox" x-on:click="$data.showSelectBox()" class="px-1.5 py-1 flex gap-0.5 bg-grey-100 hover:bg-grey-200 rounded-md cursor-pointer">
