...
use Thinktomorrow\Chief\Forms\UI\Livewire\RepeatFieldEditor;
use Thinktomorrow\Chief\Tests\ChiefTestCase;

final class RepeatFieldEditorTest extends ChiefTestCase
{
    ...
    public function test_it_can_add_a_section()
    {
        ...
        Livewire::test(RepeatFieldEditor::class, [
            'field' => $repeat,
            'locale' => 'nl',
        ])
    ...
    public function test_it_can_remove_a_section()
    {
        ...
        $component = Livewire::test(RepeatFieldEditor::class, [
            'field' => $repeat,
        ])
