...
class FileMaxRuleTest extends ChiefTestCase
{
    private $model;
    ...
    public function test_it_fails_to_upload_when_file_exceeds_max_width()
    {
        ...
        $this->assertStringContainsString('thumb is te groot en dient kleiner te zijn dan 1Kb', session()->get('errors')->first('files.thumb.nl'));
    ...
    public function test_it_fails_to_attach_asset_when_file_exceeds_max_width()
    {
    ...
    public function test_it_passes_to_attach_asset_when_file_does_not_exceed_max_width()
    {
        $asset = app(CreateAsset::class)
