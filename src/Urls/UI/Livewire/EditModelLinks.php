...
use Thinktomorrow\Chief\Urls\UI\Livewire\Links\LinkDto;
use Thinktomorrow\Chief\Urls\UI\Livewire\Links\WithLinks;

class EditModelLinks extends Component
{
    use HasForm;
    use ShowsAsDialog;
    use WithLinks;
    ...
    {
        return view('chief-urls::livewire.edit-model-links');
    }
