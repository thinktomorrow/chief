...
class LinkUpdateTestOld
{
    ...
    public function test_it_automatically_adds_an_url_on_creation()
    {
    ...
    public function test_it_adds_a_slug_for_each_locale()
    {
    ...
    public function test_it_cannot_add_same_url_for_specific_locale_twice()
    {
    ...
    public function test_it_can_use_same_url_for_same_model()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
    ...
    public function test_when_updating_an_url_it_keeps_the_old_url_as_redirect()
    {
    ...
    public function test_updating_to_same_url_as_a_redirect_one_of_same_model_will_remove_redirect()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => 'foobar-updated']);
    ...
    public function test_updating_to_an_already_existing_url_will_fail()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => 'foobar-updated']);
    ...
    public function test_updating_to_same_url_as_a_redirect_of_different_model_will_remove_redirect()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => 'foobar-updated']);
    ...
    public function test_updating_to_empty_url_will_remove_record_and_all_redirects()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
    ...
    public function test_updating_to_same_url_will_keep_records_as_they_were()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => 'foobar-updated']);
    ...
    public function test_it_can_update_to_root_slug()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => '/']);
    ...
    public function test_it_can_store_the_archived_url_as_redirect()
    {
        $this->updateLinks($this->model, ['nl' => 'foobar']);
        $this->updateLinks($this->model, ['nl' => 'foobar-updated']);
    ...
    public function test_the_updated_slug_is_prepended_with_the_basesegment()
    {
    ...
    public function test_baseurlsegment_is_taken_into_account_for_uniqueness_check()
    {
