...
<div class="space-y-4">
    ...
    <x-chief::window>
        ...
        <template x-teleport="body">
            <livewire:chief-wire-assets::gallery-asset-uploader
        ...
        <template x-teleport="body">
            <livewire:chief-wire-assets::gallery-asset-editor parent-id="{{ $this->getId() }}" />
        </template>

        <template x-teleport="body">
            <livewire:chief-wire-assets::asset-delete-dialog parent-id="{{ $this->getId() }}" />
        </template>
