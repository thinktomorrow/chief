...
class FileFieldAssetUploader extends Component implements HasPreviewFiles, HasSyncedFormInputs
{
    ...
    public function render()
    {
        ...
        return view('chief-assets::livewire.file-field-asset-uploader', [
            //
        ]);
    }
}
