...
use Thinktomorrow\Chief\Assets\UI\Livewire\Traits\InteractsWithForm;
use Thinktomorrow\Chief\Assets\UI\Livewire\Traits\ShowsAsDialog;
use Thinktomorrow\Chief\Forms\Fields\Field;

class FileFieldAssetEditor extends Component
{
    ...
    {
        $this->emitDownTo('chief-wire-image-crop::image-cropper', 'open', ['previewfile' => $this->previewFile]);
    }

    public function openHotSpots()
    {
        $this->emitToSibling('chief-wire-hotspots::hot-spot-editor', 'open', ['previewfile' => $this->previewFile]);
    }

    public function openFilesChooseExternal()
    {
        $this->emitDownTo('chief-wire-assets::external-file-field-asset-chooser', 'open', ['assetId' => $this->previewFile->mediaId]);
    }
    ...
    //    public function openImageCrop()
    //    {
    //        $this->emitToSibling('chief-wire-image-crop::image-cropper', 'open', ['previewfile' => $this->previewFile]);
    //    }
    ...
    {
        return view('chief-assets::livewire.file-field-asset-editor', [
            //
        ]);
    }
}
