...
@if ($isOpen)
    ...
    <form id="file-edit-local-form" class="space-y-4" wire:submit.prevent="submit">
    ...
    <x-slot name="footer">
        <x-chief::dialog.modal.footer>
            ...
            <x-chief::button form="file-edit-local-form" variant="blue" type="submit">Bewaar bestand</x-chief::button>
        </x-chief::dialog.modal.footer>
    </x-slot>
@endif
