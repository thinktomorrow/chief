...
class DataTableTest extends TestCase
{
    ...
    public function test_it_can_create_component()
    {
        ...
        $component = Livewire::test(DataTable::class, ['table' => $table]);
    ...
    {
        $component = Livewire::test(DataTable::class, ['table' => ScopedTableStateFixture::optionsCanBecomeEmpty()])
    ...
    public function test_it_keeps_url_filter_state_per_scoped_filter_value(): void
    {
        ...
        Livewire::withQueryParams([
            ...
            ->test(DataTable::class, ['table' => $table])
            ->set('filters.period', 'current')
    ...
    {
        $component = Livewire::test(DataTable::class, ['table' => ScopedTableStateFixture::optionsFromActiveFilters()])
            ->set('filters.period', 'archived');
