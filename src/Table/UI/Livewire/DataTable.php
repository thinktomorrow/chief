...
namespace Thinktomorrow\Chief\Table\UI\Livewire;
...
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithActions;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithBreadcrumbColumn;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithBulkActions;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithBulkSelection;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithColumns;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithColumnSelection;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithFilters;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithItemsPerPageSelection;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithNotifications;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithPagination as WithPaginationControl;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithReordering;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithRowActions;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithSorters;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithTreeResults;
use Thinktomorrow\Chief\Table\UI\Livewire\Concerns\WithVariantFilters;
...
class DataTable extends Component
{
    ...
    public function render()
    {
        if ($this->isReordering) {
            return view('chief-table::livewire.reorder.list', ['variant' => $this->variant]);
        }

        return view('chief-table::livewire.data-table', []);
    }
