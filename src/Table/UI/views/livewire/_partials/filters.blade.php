<div class="flex items-start gap-2">
    ...
    <div>
        <button type="button" x-on:click="$dispatch('open-dialog', { 'id': 'table-filters-dropdown' })">
        ...
        <x-chief::dialog.dropdown id="table-filters-dropdown" placement="bottom-end">
            <button type="button" class="text-left">
                <x-chief::dialog.dropdown.item>Filter op tags</x-chief::dialog.dropdown.item>
            </button>

            <button type="button" class="text-left">
                <x-chief::dialog.dropdown.item>Filter op datum</x-chief::dialog.dropdown.item>
            </button>

            <button type="button" class="text-left">
                <x-chief::dialog.dropdown.item>Filter op ID</x-chief::dialog.dropdown.item>
            </button>
