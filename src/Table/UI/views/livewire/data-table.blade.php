...
<div>
    ...
    <template x-teleport="body">
        <livewire:chief-wire-models::create-model :parent-component-id="$this->getId()" />
    </template>
    <template x-teleport="body">
        <livewire:chief-wire-models::edit-model :parent-component-id="$this->getId()" />
    </template>
    <template x-teleport="body">
        <livewire:chief-wire-form::action-dialog :parent-id="$this->getId()" />
    </template>
</div>
