{{-- TODO(ben): Make this dynamic --}}
@php
    //$src = \App\Models\Resources\Catalog\CatalogPage::first()
    //->asset('image')
    //->url('thumb');
...
<div class="flex size-8 items-center justify-center overflow-hidden rounded-md bg-grey-100">
    ...
    <svg class="size-5 text-grey-500" viewBox="0 0 24 24" color="currentColor" fill="none">
        <path
