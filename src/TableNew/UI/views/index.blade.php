...
<x-chief::page.layout>
    <div class="flex justify-center p-16">
        <div class="overflow-x-auto bg-white rounded-lg shadow-md w-160 whitespace-nowrap ring-1 ring-grey-300">
            {{-- ACTIES
            BULKACTIES (context)
            ROWACTIES
            FILTER
            ...
            <table class="min-w-full divide-y table-fixed divide-grey-300">
                <thead>
                    <tr>
                        <th scope="col" class="w-6 py-3 pl-4 pr-3 text-left">
                            <div class="flex items-center">
                                <input type="checkbox" name="all" id="all" class="w-4 h-4 decoration-primary-500"/>
                            </div>
                        </th>

                        <th scope="col" class="py-3 pl-3 pr-3 font-medium text-left">Id</th>
                        <th scope="col" class="py-3 pl-3 pr-3 font-medium text-left">Title</th>

                        <th scope="col" class="py-3 pl-3 pr-4 font-medium text-left">
                ...
                <tbody class="divide-y divide-grey-200">
                    @foreach($rows as $row)
                        <tr>
                            <td class="w-6 py-2 pl-4 pr-3 text-left">
                                <div class="flex items-center">
