...
class PageManager extends AbstractManager implements ModelManager
{
    /** @var UniqueSlug */
    private $uniqueSlug;
    ...
    public function fieldArrangement(): FieldArrangement
    {
        return new FieldArrangement($this->fields(), [
            ...
            new FieldTab('algemeen', ['titel', 'content']),
    ...
    public function saveFields(): ModelManager
    {
        ...
        return parent::saveFields(); // TODO: Change the autogenerated stub
    }
