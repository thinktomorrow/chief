...
class ContextRepositoryTest extends ChiefTestCase
{
    ...
    {
        $this->assertCount(0, $this->contextRepository->getByOwner($this->owner));
        $this->assertInstanceOf(Collection::class, $this->contextRepository->getByOwner($this->owner));
    }
    ...
    public function test_it_can_find_context_by_owner()
    {
        ...
        $foundContexts = $this->contextRepository->getByOwner($this->owner);
    ...
    public function test_it_can_create_context()
    {
        ...
        $this->assertCount(1, $this->contextRepository->getByOwner($this->owner));
    }
    ...
    public function test_it_can_create_context_with_available_locales()
    {
        ...
        $this->assertEquals(['nl', 'fr'], $this->contextRepository->getByOwner($this->owner)->first()->locales);
    }
