        ...
        <div class="rounded-xl border border-orange-100 bg-orange-50 p-6">
            ...
            <div class="prose prose-dark prose-spacing mt-4">
                <p>
                    ...
                    @php
                        $otherOwners = collect(app(ComposeLivewireDto::class)->getSharedFragmentDtos($model->getFragmentModel()))->reject(
                            function ($otherOwner) use ($owner) {
...
@if ($model->hasFragmentModel())
    ...
    >
        <button type="submit" form="changeFragmentStatus{{ $model->getFragmentId() }}" class="btn btn-grey icon-label">
