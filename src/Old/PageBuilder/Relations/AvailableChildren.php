...
class AvailableChildren
{
    ...
    private function collection()
    {
        ...
        foreach ($this->parent->availableModules() as $type) {
            /**
             * For some reason the collection merge looks at the model id and thus overwrites 'duplicates'.
             * This isn't expected behaviour since we have different types. For this reason we merge
             * the raw array of the collection instead of the collection itself.
             */
