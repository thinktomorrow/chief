...
class WeekDayModel extends Model implements ReferableModel, PageResource
{
    use ReferableModelDefault;
    use PageResourceDefault;

    protected $guarded = [];
    public $table = 'weektables_days';
    ...
    public function weektable(): BelongsTo
    {
        return $this->belongsTo(app(WeekTableModel::class), 'weektable_id');
    }
}
