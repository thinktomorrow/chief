...
class DateModel extends Model implements ReferableModel, PageResource
{
    use ReferableModelDefault;
    use PageResourceDefault;

    protected $guarded = [];
    public $table = 'weektables_dates';
    public $timestamps = false;

    public function getIndexTitle(): string
    {
        return 'Specifieke dagen';
    }
    ...
    {
        yield MultiSelect::make('weektables')
            ->label('Weekschema')
            ->sync();
    ...
    public function weektables(): BelongsToMany
    {
        return $this->belongsToMany(app(WeekTableModel::class), 'weektable_id');
    }
}
