const ImageCrop = function (containerElement, existingImageCrop = []) {
    this.map = new Map();
    ...
    existingImageCrop.forEach(function (hotSpot, index) {
...
ImageCrop.prototype.listen = function () {
...
ImageCrop.prototype.findHotSpotOnCoordinates = function (x, y) {
...
ImageCrop.prototype.addHotspot = function (x, y) {
    const hotspot = {
        x,
        y,
...
ImageCrop.prototype.activateHotspot = function (index) {
...
ImageCrop.prototype.emitEvent = function (eventName, hotspot) {
    const event = new CustomEvent(eventName, { detail: hotspot });
    document.dispatchEvent(event);
};

ImageCrop.prototype.calculateCoordinatesFromTopLeft = function (top, left) {
