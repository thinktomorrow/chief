...
use Thinktomorrow\Chief\Plugins\Export\Export\ExportAltCommand;
...
class ExportServiceProvider extends ChiefPluginServiceProvider
{
    public function boot(): void
    {
        ...
        $this->commands(['command.chief:export-alt']);
        ...
        $this->app->bind('command.chief:export-alt', ExportAltCommand::class);
