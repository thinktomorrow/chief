...
class ExportResourceCommandTest extends TestCase
{
    ...
    public function test_it_can_export_resource()
    {
        ...
        $this->assertEquals('article title nl', $sheet->getCell('B2')->getValue());
        ...
        $this->assertEquals('article title nl', $sheet->getCell('F2')->getValue());
        $this->assertEquals('article title en', $sheet->getCell('G2')->getValue());

        $this->assertEquals('article title nl', $sheet->getCell('B3')->getValue());
        ...
        $this->assertEquals('article title nl', $sheet->getCell('B4')->getValue());
        ...
        $this->assertEquals('article title nl', $sheet->getCell('B5')->getValue());
