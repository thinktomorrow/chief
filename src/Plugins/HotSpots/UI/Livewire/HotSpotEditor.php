...
namespace Thinktomorrow\Chief\Plugins\HotSpots\UI\Livewire;
...
use Thinktomorrow\Chief\Assets\UI\Livewire\Traits\InteractsWithGroupedForms;
...
class HotSpotEditor extends Component
{
    ...
    {
        return view('chief-hotspots::livewire.hot-spot-editor', [
            //
        ]);
    }
