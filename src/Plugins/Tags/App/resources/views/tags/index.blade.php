<x-chief::page.template title="Tags">
    ...
    <x-chief::page.grid class="mt-6 max-w-3xl">
        @foreach ($tagGroups as $tagGroup)
            ...
            <div>
                @if ($tagGroups->count() > 1)
                    <div id="taggroup-{{ $tagGroup->getTagGroupId() }}" class="mb-2 flex items-start justify-between">
                            ...
                            @if ($tagGroup->getTagGroupId())
                                <a href="{{ route('chief.taggroups.edit', $tagGroup->getTagGroupId()) }}">
                                    <x-chief::icon-button
                                        icon="icon-edit"
                                        color="grey"
                                        class="text-grey-500 shadow-none"
                                    >
                        ...
                        <a
                            ...
                            title="Tag toevoegen"
                            class="mt-1 inline-flex items-center gap-0.5 text-sm font-medium text-grey-500 hover:text-primary-500"
                        >
                ...
                @else
                    <div class="mb-2 flex items-start justify-end">
                        <a
                            ...
                            title="Tag toevoegen"
                            class="mt-1 inline-flex items-center justify-center gap-0.5 text-sm font-medium text-grey-500 hover:text-primary-500"
                        >
                            <svg width="18" height="18"><use xlink:href="#icon-plus"></use></svg>
                            <span>Tag toevoegen</span>
                        </a>
                ...
                <div class="border border-grey-200 !px-5 !py-0">
                                        ...
                                        <div class="-mr-2 flex justify-end">
                                            <a href="{{ route('chief.tags.edit', $tag->getTagId()) }}">
                                                <x-chief::icon-button
                                                    icon="icon-edit"
                                                    color="grey"
                                                    class="bg-white text-grey-500 shadow-none"
                                                />
                                            </a>
